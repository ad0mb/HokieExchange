...
class Services(Base):
    ...
    time_blocks: Mapped[list['TimeBlocks']] = relationship('TimeBlocks', back_populates='service')


class TimeBlocks(Base):
    __tablename__ = 'time-blocks'
    __table_args__ = (
        ForeignKeyConstraint(['service_id'], ['services.service_id'], ondelete='CASCADE', onupdate='CASCADE', name='time-blocks_services_service_id_fk'),
    ...
    service: Mapped['Services'] = relationship('Services', back_populates='time_blocks')
